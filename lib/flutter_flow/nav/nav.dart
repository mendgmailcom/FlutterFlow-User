...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const OtpVerificationPageWidget(),
        ),
        FFRoute(
          name: ProfileSetupPageWidget.routeName,
          path: ProfileSetupPageWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => const BookingPageWidget(),
        ),
        FFRoute(
        ...
        // Service Routes
        FFRoute(
          name: ServiceCategoriesPageWidget.routeName,
          path: ServiceCategoriesPageWidget.routePath,
          builder: (context, params) => const ServiceCategoriesPageWidget(),
        ),
        FFRoute(
          name: ServiceDetailsPageWidget.routeName,
          path: ServiceDetailsPageWidget.routePath,
          builder: (context, params) => const ServiceDetailsPageWidget(),
        ),
        FFRoute(
          name: ProviderProfilePageWidget.routeName,
          path: ProviderProfilePageWidget.routePath,
          builder: (context, params) => const ProviderProfilePageWidget(),
        ),
        // Settings Routes
        FFRoute(
        ...
        FFRoute(
          name: PaymentSettingsPageWidget.routeName,
          path: PaymentSettingsPageWidget.routePath,
          builder: (context, params) => const PaymentSettingsPageWidget(),
        ),
